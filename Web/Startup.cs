...
using SalesApp.Infrastructure.Data.Repositories.Repositories;
using SalesApp.Infrastructure.Services.Interfaces;
using SalesApp.Infrastructure.Services.Services;
using System;
...
namespace SalesApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SalesAppDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("SalesAppDefault")));
